...
<form method="post" action="addbook">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="exampleInputEmail1" name="book_title" placeholder="Enter book_title"  style="width:60%">
        @error('book_title')
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="exampleInputEmail1" name="book_description" placeholder="Enter book_description"  style="width:60%">
  ...
  @enderror
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="book_auther" id="exampleInputPassword1" placeholder="book_author"  style="width:60%">
      @error('book_auther')
      <div class="alert alert-danger" style="width:60%">{{ $message }}</div>
    @enderror
    </div>
